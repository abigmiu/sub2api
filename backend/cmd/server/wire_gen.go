...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	playgroundImageTaskRepository := repository.NewPlaygroundImageTaskRepository(db)
	...
	playgroundService := service.NewPlaygroundService(apiKeyService, subscriptionService)
	playgroundImageObjectStoreFactory := repository.NewPlaygroundImageObjectStoreFactory()
	authService.SetPlaygroundService(playgroundService)
	...
	playgroundUploadSignerFactory := repository.NewPlaygroundUploadSignerFactory()
	playgroundImageTaskService := service.NewPlaygroundImageTaskService(playgroundImageTaskRepository, settingRepository, playgroundImageObjectStoreFactory, playgroundUploadSignerFactory)
	playgroundHandler := handler.NewPlaygroundHandler(playgroundService, playgroundImageTaskService, apiKeyService, openAIGatewayHandler)
	groupService := service.NewGroupService(groupRepository, apiKeyAuthCacheInvalidator)
	handlerSettingHandler := handler.ProvideSettingHandler(settingService, buildInfo, notificationEmailService, groupService)
