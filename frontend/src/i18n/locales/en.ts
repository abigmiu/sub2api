export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        userBalanceMaxAmount: 'User Balance Max',
        userBalanceMaxAmountHint: 'When creating a recharge order, block it if the credited balance would exceed this limit',
  ...
  payment: {
    ...
    errors: {
      ...
      BALANCE_MAX_LIMIT_EXCEEDED: 'This recharge would exceed the site balance limit for your account.',
